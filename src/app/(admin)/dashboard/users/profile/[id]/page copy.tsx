...
export default function UpdateProfilePage() {
  ...
  const fetchUser = async () => {
    try {
      ...
      showErrorAlert("Error", error.message || "Failed to fetch user data");
  ...
  return (
    <div className="p-8">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold">Update Profile - {user.fullName}</h1>
      ...
      <ProfileForm
        ...
        initialData={
          user.role === "reseller" ? user.resellerProfile : user.retailProfile
        }
