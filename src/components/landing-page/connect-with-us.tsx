        ...
        <div className="flex gap-4 w-full justify-center my-8 md:my-10">
          ...
          >
            ...
            <div className="flex-1 min-w-0 hidden md:block">
              ...
              <p className="text-gray-600 text-xs md:text-sm">@yourhandle</p>
            </div>
          </a>
          ...
          <a
            ...
            className="flex items-center space-x-3 md:space-x-4 md:p-6 md:bg-white md:rounded-2xl md:shadow-lg hover:shadow-xl transition-all duration-300 group md:border md:border-gray-100"
          >
            <div className="bg-red-600 p-3 md:p-3 rounded-xl group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
              <Youtube className="w-8 h-8 md:w-6 md:h-6 text-white" />
            </div>
            <div className="flex-1 min-w-0 hidden md:block">
              <h4 className="font-semibold text-gray-800 group-hover:text-red-600 transition-colors text-sm md:text-base">
                YouTube
              </h4>
              <p className="text-gray-600 text-xs md:text-sm">@yourchannel</p>
            </div>
          </a>
        </div>
      </div>
